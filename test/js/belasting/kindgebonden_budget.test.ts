...
test("test Kindgebonden Budget 10.000, alleenstaand, 1 kind 12-", () => {
  expect(
    kgb.kindgebondenBudget(
      JAAR,
      10000,
      kgb.maxKindgebondenBudget(JAAR, A1K, false),
      false
    )
  ).toEqual(A1K_MAX);
});
...
test("test Kindgebonden Budget 10.000, 2 V, 1 kind 12-", () => {
  expect(
    kgb.kindgebondenBudget(
      JAAR,
      10000,
      kgb.maxKindgebondenBudget(JAAR, M1K, true),
      true
    )
  ).toEqual(M1K_MAX);
});
...
test("test Kindgebonden Budget 10.000, alleenstaand, 1 kind 12-, 1 kind 12-15, 1 kind 16-17", () => {
  expect(
    kgb.kindgebondenBudget(
      JAAR,
      10000,
      kgb.maxKindgebondenBudget(JAAR, A3K, false),
      false
    )
  ).toEqual(A3K_MAX);
});
