...
test('Algemene Heffings Korting 40.000', () => {
  expect(inkomen.algemeneHeffingsKorting(JAAR, 1000, false)).toEqual(1000)
  expect(inkomen.algemeneHeffingsKorting(JAAR, 1000, true)).toEqual(1000)
})

test('Algemene Heffings Korting 100.000', () => {
  expect(inkomen.algemeneHeffingsKorting(JAAR, 10000, false)).toEqual(0)
  expect(inkomen.algemeneHeffingsKorting(JAAR, 10000, true)).toEqual(0)
})
