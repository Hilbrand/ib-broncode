...
import { VisualisatieType, InvoerGegevensType, LeeftijdType, PeriodeType, PersoonType, SalarisVerhogingType, TabType, VisualisatieTypeType, WoningType, NavigatieType, WonenType } from "../../src/ts/types";
